...
class LocoTrack(nn.Module):
  ...
  def __init__(
    ...
    if model_size == 'small':
      ...
      self.input_channels = 934 #256*3+84+2+80(24+40+16)
      self.highres_dim = 24
      self.lowres_dim = 40
      self.lowest_dim = 16
    ...
    elif model_size == 'efficentnet_b0_16_24_40_tiny':
      model_params = {
        'dim': 128,
        'num_heads': 2,
        'num_layers': 3,
      ...
      self.input_channels = 550 #128*3+84+2+80(24+40+16)
      self.highres_dim = 24
      self.lowres_dim = 40
      self.lowest_dim = 16
      self.efficientnet_feature_extractor = nets.EfficientNet_b0_feature_extractor_16_24_40(model_name='efficientnet-b0')
    
    elif model_size == 'small_efficentnet_256_16_40_88':
      model_params = {
        'dim': 256,
        'num_heads': 4,
        'num_layers': 3,
      ...
      self.lowres_dim = 88
      self.lowest_dim = 16
      self.efficientnet_feature_extractor = nets.EfficientNet_256_feature_extractor_16_40_88(model_name='efficientnet-256')
    
    elif model_size == 'small_efficentnet_b0_16_40_112':
      model_params = {
        'dim': 256,
        'num_heads': 4,
        'num_layers': 3,
      ...
      self.lowres_dim = 112
      self.lowest_dim = 16
      self.efficientnet_feature_extractor = nets.EfficientNet_b0_feature_extractor_16_40_112(model_name='efficientnet-b0')
    
    elif model_size == 'small_efficentnet_b2_16_48_120':
      model_params = {
        'dim': 256,
        'num_heads': 4,
        'num_layers': 3,
      ...
      self.lowres_dim = 120
      self.lowest_dim = 16
      self.efficientnet_feature_extractor = nets.EfficientNet_b2_feature_extractor_16_48_120(model_name='efficientnet-b2')
    else:
